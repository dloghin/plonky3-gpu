...
/** Comma-separated FIPS 180-4 round constants K_0..K_63 (single source for host and device). */
#define P3_SHA256_K_LIST                                                                               \
...
/** Comma-separated SHA-256 initial hash value H_0^{(256)} (single source for host and device). */
#define P3_SHA256_IV_LIST                                                                              \
    0x6a09e667u, 0xbb67ae85u, 0x3c6ef372u, 0xa54ff53au, 0x510e527fu, 0x9b05688cu, 0x1f83d9abu, 0x5be0cd19u

/** FIPS 180-4 round constants K_0..K_63. */
inline constexpr uint32_t SHA256_K[64] = {P3_SHA256_K_LIST};
...
P3_HOST_DEVICE P3_INLINE void compress_two_to_one_raw(
    ...
    uint8_t out[32]) {
    const uint32_t h_init[8] = {P3_SHA256_IV_LIST};
...
#undef P3_SHA256_K_LIST
#undef P3_SHA256_IV_LIST
